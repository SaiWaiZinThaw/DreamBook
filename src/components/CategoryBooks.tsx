    ...
    <div className="flex flex-col w-full min-h-screen px-6 mx-0 lg:px-10">
      <div className="flex justify-between lg:gap-0 gap-4 mt-4 h-[30px] lg:h-[50px] w-full">
        <div className="flex items-center w-8/12 gap-3 lg:w-full">
          <img src={Sorting} alt="sorting" className="w-4/12 h-full" />
      ...
      <div className="grid w-full grid-cols-2 py-6 lg:p-10 lg:gap-8 lg:grid-cols-4">
        {!isBooksLoading &&
          booksData &&
          booksData.items.map((book: Book) => (
            <div
              key={book.bookId}
              id={book.bookId}
              className="relative w-[150px] py-2 lg:py-0 bg-slate-100 shadow-md shadow-secondary-foreground lg:mr-[21px] border rounded-[8px] lg:w-[232px] lg:h-[280px] book group"
            >
