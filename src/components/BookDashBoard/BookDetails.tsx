            ...
            <div className="mt-[30px]">
              <div className="flex flex-col mx-[33px] lg:h-[620px]">
                <div className="w-full">
                  ...
                  <Input
                    id="title"
                    className="border-gray-300 p-3 border rounded-lg w-full md:w-[498px] md:h-[50px] text-base"
                  ...
                  <div className="w-full md:w-[600px] h-[265px]">
                    {isEditing ? (
                      <ReactQuill
                        ...
                        className="border-gray-300 p-3 border rounded-lg h-full md:h-[250px]"
                      />
                    ) : (
                      <div
                ...
                <div className="mt-[30px] w-full md:w-[498px] md:h-[103px]">
                  ...
                  <div className="flex flex-wrap items-center border-gray-300 p-3 border rounded-lg">
                    {isEditing ? (
                      <div className="flex flex-wrap gap-2">
                        {keywords.map((keyword, index) => (
                          <div
                            key={index}
                            className="flex items-center bg-blue-100 px-2 py-1 rounded-full text-blue-500"
                          >
                            {keyword}
                            <BsX
                        ...
                        <Input
                          id="keywords"
                          className="border-0 p-0 text-sm md:text-base outline-none focus:outline-none"
                      ...
                      <div className="flex flex-wrap gap-2">
                        {keywords.map((keyword, index) => (
                          <div
                            key={index}
                            className="bg-blue-100 px-2 py-1 rounded-full text-blue-500"
                          >
                            {keyword}
                          </div>
                        ))}
                ...
                <AlertDialog>
                  <AlertDialogTrigger asChild>
                    <Button
                      variant="ghost"
                      className="mt-[30px] font-bold text-red-500 self-start"
                    >
                      Delete this book
                    </Button>
                  </AlertDialogTrigger>
