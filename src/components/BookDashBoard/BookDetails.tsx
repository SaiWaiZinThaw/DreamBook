...
//   const numericBookId = bookId ? parseInt(bookId) : NaN;
//   const navigate = useNavigate();
//   const [activeTab, setActiveTab] = useState(null); // Initialize activeTab as null
//   const [isEditing, setIsEditing] = useState(false);
//   const token = getToken() || "";
//   const { data: fetchABookAuthor } = useFetchABookAuthor(token, numericBookId);
...
//         {fetchABookAuthor?.map(bookauthor => (
//           <div key={bookauthor.bookId} className="flex flex-col">
//           <div className="flex border-slate-300 border-b h-[80px]">
//             <h1 className="my-[20px] pl-[40px] font-extrabold text-2xl">Book Details</h1>
  
//             <Tabs defaultValue="status" className="bg-slate-200 my-[13px] ml-[650px] rounded-[8px] w-[206px] h-[40px] text-slate-400">
...
//                               <Input type="text" id="title" placeholder={bookauthor.title} className="border-slate-300 border"/>
...
//                               type="text"
//                               id="category"
//                               placeholder={bookauthor.category}
...
//                           <Input type="text" id="keywords" placeholder={bookauthor.keywords} className="border-slate-300 border"/>
//                       </div>
...
//                               <textarea
//                                   id="description"
//                                   placeholder={bookauthor.description}
          ...
          <div className="flex">
            <div className="border-slate-300 ml-[12px] border-r w-[667px] h-[982px]">
                <div className="h-[581px]">
                    ...
                    <div className="items-center gap-1.5 grid mx-[32px] pt-[90px] w-[603px] h-[74px]">
                        <Label htmlFor="keywords" className="font-semibold text-[16px]">Keywords</Label>
                        <h1 id="keywords" className="border-slate-300 py-[8.5px] pl-[16px] border rounded-[5px] h-[45px] font-semibold text-black">{fetchABookAuthor?.keywords}</h1>
                    </div>
