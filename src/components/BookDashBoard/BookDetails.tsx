...
const BookDetails = () => {
  ...
  const {mutate: deleteBook} = useSoftDeleteBook();
                      ...
                      <AlertDialog>
                        ...
                        <AlertDialogContent className="bg-slate-50 rounded-none">
                          ...
                          <AlertDialogFooter>
                            ...
                            <AlertDialogAction
                              onClick={() => handleDeleteConfirm(parseInt(bookId!))}
              ...
              <div className="mx-8 mt-[84px] w-[232px] h-[314px]">
                ...
                <div className="bg-slate-100 shadow-xl border rounded-[8px] w-[232px] h-[300px]">
                  ...
                  <div className="ml-2">
                    ...
                    <h2 className="flex my-2 font-medium text-md">
                      <img src={fetchABookAuthor?.user.profilePicture} alt="" className="mr-2 rounded-full w-[23px] h-[23px]"/>
                      <h1 className="font-bold text-md">{fetchABookAuthor?.user.name}</h1>
                    </h2>
                  </div>
                </div>
              </div>
