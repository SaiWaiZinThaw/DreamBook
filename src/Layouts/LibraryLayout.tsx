...
const LibraryLayout = () => {
  ...
  const [isCheckedDigitalMarketing, setIsCheckedDigitalMarketing] =
    useState(false);
  const [isCheckedPersonalDevelopment, setIsCheckedPersonalDevelopment] =
    useState(false);
  ...
  const [isCheckedContentMarketing, setIsCheckedContentMarketing] =
    useState(false);
