import { ChapterOutline, FooterImg, LightCommentOutline, LightMenuBook } from "@/assets"
    ...
    <div className="flex mx-0 px-0 container">
      <div className="flex">
        <div className="bg-primary bg-opacity-90 w-[296px] h-[982px]">
          <img src={FooterImg} alt=""  className="border-slate-300 mx-[33.5px] py-[7.5px] border-b w-[223px]"/>
