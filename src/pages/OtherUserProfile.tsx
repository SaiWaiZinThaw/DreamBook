...
import { useGetOther, useGetUserBook } from "@/hooks/useUser";
...
const OtherUserProfile = () => {
  ...
  const { data: userBookData, isLoading: BookIsLoading } = useGetUserBook(
    userId!
  );
  ...
  useEffect(() => {
    if (userBookData) {
      ...
      userBookData.items.forEach((book) => {
